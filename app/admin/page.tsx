...
import { FileText, Home, Users, Eye } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">Recent listings added to the platform.</p>
            {/* List would go here */}
            <div className="mt-4 space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">Luxury Villa {i}</p>
                    <p className="text-sm text-muted-foreground">Islamabad</p>
                  </div>
                  <div className="font-medium">PKR 4.5 Cr</div>
                </div>
              ))}
            </div>
          </CardContent>
